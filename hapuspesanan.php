...
<head>
    ...
    <title>Hapus Pesanan | DurianGo</title>
</head>
    ...
    if ($query) { ?>
        ...
        <section>
            ...
            <div class="editlihattiket container" style="Padding:180px;">
                ...
                <h1>Pesanan anda sedang proses refund</h1>
                <p>Note : Kami belum bisa memastikan refund pesanan anda, refund pemesanan durian dapat atau tidak tergantung kebijakan dari toko yang menentukan prosedur dan syarat-syarat yang berlaku untuk pengembalian dana. Lebih lanjutnya akan kami hubungi ke Email anda yang sudah tertera, Terimakasih.</p>
                <br><br>
                <a href="lihatpesanan.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Kembali</a>
