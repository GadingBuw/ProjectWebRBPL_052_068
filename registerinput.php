            ...
            <div class="logincont">
                ...
                <div class="login">
                    ...
                    if ($query) { ?>
                        ...
                        <button class="btn btn-warning " type="submit " style="background-color: rgb(247, 241, 77);border-color: rgb(26, 26, 26); width : 400px; height: 40px;border-radius: 8px; margin-bottom:10px; border-style:none">REGISTER</button>
                        <center>
