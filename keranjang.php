            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mr-auto">
                    <li class="nav-item" style="margin-left: 100px;">
                        ...
                        <form class="form-inline" action="searchproduk.php" method="POST">
                ...
                <tr>
                    ...
                    <td>
                        <ul class="list-group">
                            ...
                            <li class="list-group" style="margin-bottom: 10px; width: 100px;"><a href="https://id-id.facebook.com/login/device-based/regular/login/?login_attempt=1"><svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" fill="white" class="bi bi-facebook" viewBox="0 0 16 16" style="margin-left: 10px;margin-bottom: 10px;margin-top:0px;">
