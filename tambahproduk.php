...
<head>
    ...
    <title>Tambah Produk | DurianGo</title>
</head>
    ...
    <section>
        ...
        <div class="editform container" style="display: flex;">
            ...
            <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:10px;">
                ...
                <h3>Selamat datang Admin, mau tambah produk yaa</h3><br><br>
                ...
                <form method="POST" action="inputproduk.php" enctype="multipart/form-data">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" name="stok" class="form-control" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td> <input type="text" name="deskripsi" class="form-control " style="margin-left: 10px;margin-bottom: 20px;width:500px; ">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <td></td>
                        <td><button type="submit" role="button" name="upload" style="padding:9px; font-size:16px;margin-left: 10px; background-color: blueviolet ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;">Tambah Produk</button></td>
                        </tr>
