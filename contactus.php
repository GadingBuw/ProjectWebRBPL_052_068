...
<body>
    ...
    <div class="editnav">
        <nav class="navbar navbar-expand-lg navbar-dark ">
            <a class="navbar-brand" href="homesession.php"><img src="Durian GO.png" alt="" style="height: 40px; margin-right: 1px;"></a>
    ...
    <section>
        ...
        <div class="container" style=" margin-top: 70px; gap: 64px;margin-bottom: 30px;margin-left: 210px; padding-right: 500px;font-size: 17px;font-family: sans-serif;">
            ...
            <p>Jika masih bingung tentang pemesanan Durian atau seputar durian tanyakan saja pada kami, atau jika ada kritik maupun saran jangan ragu untuk hubungi kepada kita</p>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td> <select id="inputperihal" name="perihal" class="form-control " style="margin-left: 10px;margin-bottom: 20px;width:500px;">
                                    ...
                                    <option>Pertanyaan seputar produk</option>
            ...
            <div class="formright" style="margin-left: 50px;font-family:Poppins; font-size:13px; padding:8px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td> <a href="https://id-id.facebook.com/login/device-based/regular/login/?login_attempt=1" style="margin-left: 10px;margin-bottom: 10px; color: black;text-decoration:none;">DurianGo</a></td>
                    </tr>
                    <tr>
                        ...
                        <td> <a href="https://www.instagram.com/accounts/login/" style="margin-left: 10px;margin-bottom: 10px;color: black;text-decoration:none;">DurianGo</a></td>
                    </tr>
                    <tr>
                        ...
                        <td> <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiaWQifQ%3D%3D%22%7D" style="margin-left: 10px;margin-bottom: 10px;color: black;text-decoration:none;">DurianGo.com</a></td>
                    </tr>
                </table>
            </div>
        </div>
