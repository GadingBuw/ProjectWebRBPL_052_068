...
<head>
    ...
    <title>Add Admin | DurianGo</title>
</head>
            ...
            <div class="logincont">
                ...
                <div class="login">
                    ...
                    <form method="POST" action="registeradmin.php">
                        ...
                        <button class="btn btn-warning " type="submit " style="background-color: rgb(254, 254, 94);border-color: rgb(26, 26, 26); width : 400px; height: 40px;border-radius: 8px; margin-bottom:10px; border-style:none">Tambah Admin</button>
                        <center>
