...
<body>
    ...
    $query = mysqli_query($konek, "INSERT INTO pesanan VALUES('','$id','$nama','$email','$jenis','$alamat','$jumlah','$total')") or die(mysqli_error($konek));
            ...
            <div class="editform container" style="display: flex;">
                ...
                <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:10px;">
                    ...
                    <h5>
                        ...
                        Durian akan segera diproses untuk pembayaran lebih lanjut sudah kami kirimkan ke email anda , ingin lihat pesanan anda? klik
                    </h5>
                    <h5>
