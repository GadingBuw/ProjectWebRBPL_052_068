...
<body>
    ...
    <section>
        ...
        include 'konek.php';
        $query = mysqli_query($konek, "select * from pesanan where id = '$id'");
        while ($data = mysqli_fetch_array($query)) {
            $angka = $angka + 1; ?>
            ...
            <div class="editlihattiket container" style="display: flex;">
                ...
                <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:0px;padding-bottom:20px;">
                    ...
                    <br>
                    <a href=hapuspesanan.php?id=<?php echo $data['idpesanan']; ?> style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Batalkan</a>
