            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mr-auto">
                    <li class="nav-item" style="margin-left: 100px;">
                        ...
                        <form class="form-inline" action="searchprodukadmin.php" method="get">
                            <input class="form-control mr-sm-0" type="search" placeholder="Cari Produk Disini" aria-label="Search" style="border-top-right-radius: 0px ; border-bottom-right-radius: 0px; margin-right: 0px; width: 450px;">
                ...
                <div class="navbar-nav ml-auto" style="font-family: Poppins;font-size:14px;">
                    ...
                    <a href="tambahproduk.php" style="margin-right: 13px;margin-top:8px;text-decoration:none; color:white;">Tambah Produk </a>
    ...
    <div class="editmedia container">
        <div class="media-scroller container">
            ...
            if (isset($_POST['search'])) {
                $cari = $_POST['search'];
                $query = mysqli_query($konek, "select * from tambahproduk where judul like '%" . $cari . "%'");
            } else {
